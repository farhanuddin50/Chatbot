...
pairs = [
    ...
    [r"(.*) your name ?", ["My name is Mr. Bot, but you can just call me robot and I'm a chatbot .",]],
    ...
    [r"(.*)created(.*)", ["Farhan created me using Python's NLTK library", "Top secret 🤫",]],
